...
const Navbar = () => {
    ...
    return (
        <div className="bg-white border-b border-gray-200/80 backdrop-blur-[2px] sticky top-0 z-30">
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-white border-t border-gray-200">
                    <div className="px-4 py-3 space-y-3">
                        <NavLink 
                            to="/dashboard" 
                            className="block text-sm text-slate-600 hover:text-indigo-600 transition-colors py-2"
                            style={({ isActive }) => isActive ? activeLinkStyle : undefined}
