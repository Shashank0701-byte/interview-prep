...
const ReviewPage = () => {
    ...
    const handlePracticeNow = (question) => {
    ...
    return (
        <DashboardLayout>
            {isPracticeMode && practiceQuestion ? (
                <PracticeView question={practiceQuestion} onClose={handleClosePractice} />
            ) : (
                <div
                                ...
                                >
                                    <div className="bg-white/70 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-slate-200/80">
                                        ...
                                        {showAnswer ? (
                                            <div className="mt-4 pt-4 border-t border-slate-200">
                                                ...
                                                <div className="flex justify-center gap-3 md:gap-4 mt-8">
                                                    <button
                                                        ...
                                                        className="btn-primary bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-lg ..."
                                                    >
                                                        Again
                                                    </button>
                                                    <button
                                                        onClick={() => handleReview(currentQuestion._id, 'hard')}
                                                        className="btn-primary bg-red-100 hover:bg-red-200 text-red-700 font-semibold py-3 px-6 rounded-lg ..."
                                                    >
                                                        Hard
                                                    </button>
                                                    <button
                                                        onClick={() => handleReview(currentQuestion._id, 'good')}
                                                        className="btn-primary bg-blue-100 hover:bg-blue-200 text-blue-700 font-semibold py-3 px-6 rounded-lg ..."
                                                    >
                                                        Good
                                                    </button>
                                                    <button
                                                        onClick={() => handleReview(currentQuestion._id, 'easy')}
                                                        className="btn-primary bg-green-100 hover:bg-green-200 text-green-700 font-semibold py-3 px-6 rounded-lg ..."
                                                    >
                                                        Easy
                                                    </button>
                                                </div>
                                            ...
                                            <>
                                                <button onClick={() => setShowAnswer(true)} className="btn-primary mt-4">
                                                    Show Answer
                                                </button>
                                                <div className="flex justify-center mt-4">
                                                    <PracticeNowButton onClick={() => handlePracticeNow(currentQuestion)} />
                                                </div>
                                            </>
                                        )}
                                    </div>
