...
const ParticipantsList = ({ participants, currentUser, isHost }) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 h-80">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  {/* Status indicator */}
                  <div className={`absolute -bottom-1 -right-1 w-3 h-3 ${getStatusColor(participant)} rounded-full border-2 border-white`}></div>
                </div>
